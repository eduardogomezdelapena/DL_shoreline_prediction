...
class TaylorDiagram(object):
    ...
    def __init__(self, refstd,
        ...
        * extend: extend diagram to negative correlations
        ...
        ax.axis["top"].major_ticklabels.set_fontsize(sz_tk)        
        ax.axis["top"].label.set_axis_direction("top")
        ax.axis["top"].label.set_text("Correlation")
        ax.axis["top"].label.set_fontsize(sz)

        ax.axis["left"].set_axis_direction("bottom")  # "X axis"
        ax.axis["left"].label.set_text("Standard Deviation")
        ax.axis["left"].label.set_fontsize(sz)
        ax.axis["left"].major_ticklabels.set_fontsize(sz_tk)          
        
        ax.axis["right"].set_axis_direction("top")    # "Y-axis"
        ax.axis["right"].toggle(ticklabels=True)
        ax.axis["right"].major_ticklabels.set_fontsize(sz_tk)         
